    ...
    async onload() {
        try {
            ...
            try {
                ...
                console.error('Failed to initialize BlockExecutor:', error);
                throw error;
            }
            ...
            try {
                this.registerMarkdownCodeBlockProcessor(
                    ...
                    async (source, el, ctx) => {
                        ...
                        el.empty();
                        const container = el.createDiv('simplejs-output');
                        const loading = container.createDiv('simplejs-loading');
                        loading.setText('Processing SimpleJS block...');
                        
                        try {
                            if (!this.blockExecutor) {
                                throw new Error('BlockExecutor not initialized');
                            }
                ...
                console.log('Code block processor registered for "simplejs"');
            } catch (error) {
                console.error('Failed to register code block processor:', error);
                throw error;
            }
            ...
            try {
                ...
                console.error('Failed to add settings tab:', error);
                // Don't throw, settings tab is not critical
            }
            ...
            try {
                ...
                // Don't throw, commands are not critical
            }

            console.log('SimpleJS Plugin loaded successfully');
        } catch (error) {
            console.error('Failed to load SimpleJS Plugin:', error);
            throw error;
        }
    }
